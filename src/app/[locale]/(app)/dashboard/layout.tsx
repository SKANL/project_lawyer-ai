...
/**
 * Layout del área privada de la app.
 * Inyecta datos del usuario y org al AppSidebar de forma segura (Server Component).
 */
export default async function DashboardLayout({
  ...
  // Traer datos de la organización a través del perfil
